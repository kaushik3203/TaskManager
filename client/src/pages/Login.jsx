        ...
        <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
          ...
          >
            ...
            <div className='flex flex-col gap-y-5'>
              ...
              />
              <div className='flex justify-between text-sm text-gray-600 hover:underline cursor-pointer'>
                <span className='text-sm text-gray-600 hover:underline cursor-pointer'>
                  Forget Password?
                </span>
                <a href="/register" className='text-sm text-blue-600 hover:underline cursor-pointer'>
                  Register Now
                </a>
              </div>
            </div>
